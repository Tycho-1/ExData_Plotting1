...
# Setting the global graphics - two columns and two rows 
...
legend("topright",
       ...
       col = c("black","red","blue"), lty = 1, cex = .9, bty = "n")
# Plotting the third graph
with(el_power_subset,plot(Date,Voltage,type = "l",
                          xlab = "datetime", ylab = "Voltage"))
# Plotting the fourh graph
with(el_power_subset, plot(Date, Global_reactive_power, type = "l", 
                           xlab = "datetime"))
